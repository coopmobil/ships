...
public class BattlefieldView extends android.view.View {
	...
	private static String [] letterArra = {"", "A","B", "C", "D", "E", "F", "G", "H", "I", "J"}; // mehr f�r gr��ere Felder (maximal 10 x 10)
	...
	//	mShipFieldInstance = ShipField.getInstance(); // setzt im Zweifel die Gr��e des Feldes
	}
    ...
    private void drawAvailableShips() {
    	...
    	mCanvas.drawText("noch m�gliche Schiffe:", xOffSet, yOffSet, mTextPaint);
